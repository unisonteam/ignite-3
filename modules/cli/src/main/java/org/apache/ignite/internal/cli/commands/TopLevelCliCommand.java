...
@Command(name = "ignite",
        ...
        footer = {
                ...
                "    ignite connect http://localhost:10300",
                "",
                "  Execute a SQL query non-interactively:",
                "    ignite sql --jdbc-url jdbc:ignite:thin://127.0.0.1:10800 \"SELECT * FROM t\"",
                "",
                "  Execute SQL from a file:",
                "    ignite sql --jdbc-url jdbc:ignite:thin://127.0.0.1:10800 --file=script.sql",
                "",
                "  Set default JDBC URL to avoid passing --jdbc-url every time:",
                "    ignite cli config set ignite.jdbc-url jdbc:ignite:thin://127.0.0.1:10800",
                ""},
        subcommands = {
                SqlCommand.class,
