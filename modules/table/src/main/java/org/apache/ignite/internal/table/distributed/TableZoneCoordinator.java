...
class TableZoneCoordinator {
    ...
    static PartitionSet extendPartitionSet(@Nullable PartitionSet oldPartitionSet, int partitionId) {
    ...
    static <T> Function<Throwable, T> ignoreTableClosedException() {
        return ex -> {
    ...
    static class TableClosedException extends IgniteInternalException {
