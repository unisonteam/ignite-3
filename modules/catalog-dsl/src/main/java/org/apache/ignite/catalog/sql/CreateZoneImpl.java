...
import static org.apache.ignite.catalog.sql.QueryPartCollection.wrap;
...
class CreateZoneImpl extends AbstractCatalogQuery {
    ...
    CreateZoneImpl replicas(Integer n) {
        Objects.requireNonNull(n, "replicas count is null");
        withOptions.add(WithOption.replicas(n));
        return this;
    }

    CreateZoneImpl partitions(Integer n) {
        Objects.requireNonNull(n, "partitions is null");
        withOptions.add(WithOption.partitions(n));
        return this;
    }

    CreateZoneImpl affinityFunction(String function) {
        Objects.requireNonNull(function, "function is null");
        withOptions.add(WithOption.affinityFunction(function));
        return this;
    }
