...
public interface FlowBuilder<I, O>  {
    ...
    <QT> FlowBuilder<I, QT> question(String questionText, List<QuestionAnswer<QT>> answers);

    FlowBuilder<I, O> exceptionHandler(ExceptionHandler<?> exceptionHandler);

    FlowBuilder<I, O> output(PrintWriter output);

    FlowBuilder<I, O> errorOutput(PrintWriter errorOutput);
