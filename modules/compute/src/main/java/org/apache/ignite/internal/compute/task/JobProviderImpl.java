...
import org.apache.ignite.compute.task.JobProvider;
...
public class JobProviderImpl implements JobProvider {
    ...
    public JobProviderImpl(JobContextManager jobContextManager, List<DeploymentUnit> units) {
        this.jobContextManager = jobContextManager;
        this.units = units;
    }

    @Override
    public <R> ComputeJob<R> getJob(String className) {
