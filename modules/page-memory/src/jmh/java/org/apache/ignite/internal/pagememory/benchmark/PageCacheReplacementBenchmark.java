 ...
 *     <li>Access Pattern: Zipfian with skew=0.99 (commonly used in YCSB and academic literature)</li>
 * </ul>
 *
...
public class PageCacheReplacementBenchmark extends PersistentPageMemoryBenchmarkBase {
     ...
     * This value is commonly used in YCSB benchmarks and academic literature
     * (e.g., "Workload Analysis of a Large-Scale Key-Value Store", Cooper et al., SIGMOD 2010,
     * DOI: 10.1145/1807167.1807152).
     */
    ...
    public enum CachePressure {
         ...
         */
        public int computeWorkingSetSize(long capacity) {
            // Check for overflow BEFORE multiplication
            // If capacity * multiplier would exceed Long.MAX_VALUE, catch it early
            if (capacity > Long.MAX_VALUE / (long) multiplier) {
            ...
            long result = (long) (capacity * multiplier);
    ...
    public static class ThreadState {
        ...
        public void setupTrial(ThreadParams threadParams, PageCacheReplacementBenchmark benchmark) {
            ...
            long minWorkingSetSize = (long) (benchmark.regionCapacityPages * MIN_WORKING_SET_RATIO);
    ...
    private void validateConfiguration() {
        ...
        if (workingSetSize > 10_000_000) {
            throw new IllegalStateException(String.format(
                    ...
                    workingSetSize,
                    (workingSetSize * PAGE_SIZE) / (1024L * 1024 * 1024),
    ...
    private void allocateWorkingSet() throws Exception {
        ...
        long batchSizeLong = (long) (regionCapacityPages * 0.8);
    ...
    private void warmupCache() throws IgniteInternalCheckedException {
        ...
        long warmupPagesLong = (long) (regionCapacityPages * WARMUP_MULTIPLIER);
