...
public class ClusterConfigurationController extends AbstractConfigurationController {
    ...
    public ClusterConfigurationController(ConfigurationPresentation<String> clusterCfgPresentation) {
    ...
    @Put
    public void updateConfiguration(@Body String updatedConfiguration) {
