...
public class LocalFileConfigurationStorageNamedListTest {
    ...
    @BeforeEach
    public void before() {
        storage = new LocalFileConfigurationStorage(getConfigFile(), List.of(FirstConfiguration.KEY));
...
//        assertThat(storage.readDataOnRecovery().thenApply(Data::values), willBe(anEmptyMap()));
    ...
    public void errors() throws Exception {
        var b = new NamedListNode<>("name", LocalFileConfigurationStorageNamedListTest::instantiateChildNode, null);
    ...
    public void testUpdate() {
        var list = new NamedListNode<SecondChange>("name", LocalFileConfigurationStorageNamedListTest::instantiateChildNode, null);
    ...
    void testCreateAfterErrors() {
        var list = new NamedListNode<>("name", LocalFileConfigurationStorageNamedListTest::instantiateChildNode, null);
